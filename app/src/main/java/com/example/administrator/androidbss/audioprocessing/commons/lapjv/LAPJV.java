package com.example.administrator.androidbss.audioprocessing.commons.lapjv;
...
public class LAPJV {
    public static synchronized <U, V> HashMap<U, V> lap(ArrayList<U> u, ArrayList<V> v, EvalFunction evalFunc) {
    ...
    public static synchronized int[] execute(double[][] assigncost) {
