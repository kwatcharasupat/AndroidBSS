...
//        Log.i("DEBUG", "Column reduction");
        ...
        /*if (f == 0) {
            ...
            Log.i("DEBUG", "terminated at reduction transfer");
...
//        Log.i("DEBUG", "output size = " + x.length);

        for (int i = 0; i < x.length; i++) {
            output[i] = x[i] - 1;
        }

//        Log.i("DEBUG", "output = " + Arrays.toString(output));
